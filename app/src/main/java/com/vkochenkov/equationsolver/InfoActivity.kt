...
class InfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var text: String = "Любое квадратное уравнение можно представить в общем виде: \\(ax^2+bx+c=0\\), "
        text += "где \\(a\\), \\(b\\) и \\(c\\) это числовые коэффициенты перед разными степенями x. "
        text += "На пример, в уравнении \\(x^2+2x-4=0\\) кофиициенты будут такие: \\(a=1\\), \\(b=2\\), \\(c=-4\\). "
        ...
        text += "Иногда, перед тем решить уравнение, нужно сначала привести его к общему виду. "
